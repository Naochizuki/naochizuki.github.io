...
const ScrollMore = () => {
  ...
  return (
    <Box position="fixed" bottom="1em" right="3%" display={isMobile ? 'none' : 'block'}>
      {[ScrollDirection.Initial, ScrollDirection.Up].includes(scrollDirection) && (
        ...
        >
          <Icon w={6} h={6} as={RiMouseLine} color="currentColor" opacity="0.75" />
        </motion.div>
      )}
        ...
        >
          <Text
            ...
            _after={{
              ...
              content: '""',
              flex: 1,
              height: { base: '5em', xl: '5em' },
              margin: 'auto',
              marginTop: '10px',
            }}
          >
            basugandhisasangka10m@gmail.com{' '}
          </Text>
        </motion.div>
      )}
    </Box>
