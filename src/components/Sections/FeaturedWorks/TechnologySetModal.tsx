...
const TechnologySetModal = ({ isOpen, onClose, technologies }: ITechnologySetModal) => {
  ...
  const iconLibrariesCols = splitTechnologies(Technologies['icon libraries'], technologies)
  const httpClient = splitTechnologies(Technologies['http client'], technologies)
  const webServer = splitTechnologies(Technologies['web server'], technologies)
    ...
    <Modal isOpen={isOpen} onClose={onClose} motionPreset="slideInBottom" scrollBehavior="inside">
      ...
      <ModalContent>
        ...
        <ModalBody className={styles.technologyModal}>
          ...
          <TechnologyList title={t('technologyList.iconLibraries')} columns={iconLibrariesCols} />
          ...
          <TechnologyList title={t('technologyList.httpClient')} columns={httpClient} />
          <TechnologyList title={t('technologyList.webServer')} columns={webServer} />
          <TechnologyList
